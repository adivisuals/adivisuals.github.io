      ...
      <section className="py-24 bg-zinc-950 relative overflow-hidden" ref={showreelSection.ref}>
        ...
        <div className="max-w-5xl mx-auto px-6 relative z-10">
          ...
          <div className="relative block w-full aspect-video bg-zinc-900 border border-white/8 group overflow-hidden hover-lift amber-glow transition-all duration-500">
            ...
            {/* Functional Mute/Unmute Button */}
            <button
              onClick={toggleMute}
              className="absolute bottom-5 right-5 z-10 flex items-center gap-2 px-3 py-1.5 bg-black/70 border border-white/10 text-gray-300 hover:bg-black/90 hover:border-amber-400/40 hover:text-amber-400 transition-colors duration-300 cursor-pointer backdrop-blur-sm"
            ...
            >
              ...
              <span className="text-[10px] tracking-widest uppercase">{isMuted ? "Unmute" : "Mute"}</span>
            </button>
